...
is $match<head1>[0]<paragraph><text>.Str, "heading 1", 'Parser extracted header 1';

is $match<head2>.elems, 1, 'Parser extracted one head2';
is $match<head2>[0]<paragraph><text>.Str, "heading 2", 'Parser extracted header 2';

is $match<head3>.elems, 1, 'Parser extracted one head3';
is $match<head3>[0]<paragraph><text>.Str, "heading 3", 'Parser extracted header 3';

is $match<head4>.elems, 1, 'Parser extracted one head4';
is $match<head4>[0]<paragraph><text>.Str, "heading 4", 'Parser extracted header 4';

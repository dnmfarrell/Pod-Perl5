...
=item * L<This is a link for the Time::Piece module|Time::Piece/USAGE> should convert into a perldoc link to Time::Piece

=item * L<Time::Piece> should convert into a perldoc link to Time::Piece

=item * L<https://github.com> should just be a pure url (text and href equal)
